...
const WHATS_NEW = {
  'en-US': 'New: AI opponents in races - 2 to 4 rivals by difficulty, with your finish position. The simulator now has live animated water and an interactive points-of-sail wind rose. Global leaderboard. A clearer Points of Sail diagram. Plus polish and fixes.',
  ru: 'Новое: AI-соперники в гонке - от 2 до 4 лодок по сложности, с вашим местом на финише. В симуляторе живая анимированная вода и интерактивная роза курсов относительно ветра. Глобальный лидерборд. Более наглядная диаграмма курсов относительно ветра. Плюс улучшения и исправления.',
  pl: 'Nowosc: rywale AI w wyscigu - od 2 do 4 lodzi wedlug poziomu, z twoim miejscem na mecie. W symulatorze zywa animowana woda i interaktywna roza kursow wzgledem wiatru. Globalny ranking. Bardziej czytelny diagram kursow. Plus usprawnienia i poprawki.',
  'es-ES': 'Nuevo: rivales con IA en las regatas - de 2 a 4 barcos según la dificultad, con tu posición de llegada. El simulador ahora tiene agua animada en vivo y una rosa de rumbos interactiva. Clasificación global. Diagrama de rumbos más claro. Además mejoras y correcciones.',
  'fr-FR': "Nouveau : des adversaires IA dans les courses - de 2 à 4 bateaux selon la difficulté, avec votre place à l'arrivée. Le simulateur a maintenant une eau animée en direct et une rose des allures interactive. Classement mondial. Diagramme des allures plus clair. Plus des améliorations et corrections.",
  'de-DE': 'Neu: KI-Gegner in Rennen - 2 bis 4 Boote je nach Schwierigkeit, mit deiner Zielposition. Der Simulator hat jetzt lebendiges animiertes Wasser und eine interaktive Kurs-Windrose. Globale Bestenliste. Ein anschaulicheres Kursdiagramm. Dazu Verbesserungen und Korrekturen.',
  it: "Novità: avversari IA nelle regate - da 2 a 4 barche secondo la difficoltà, con la tua posizione all'arrivo. Il simulatore ora ha acqua animata dal vivo e una rosa delle andature interattiva. Classifica globale. Diagramma delle andature più chiaro. Più miglioramenti e correzioni.",
};
