...
const PRIMARY_ENTRIES: SimEntry[] = [
  {
    ...
    desc: {
      ru: 'Ветер, повороты и угол к ветру. Начни здесь. Нужен интернет.',
      en: 'Wind, turns and the angle to the wind. Start here. Needs internet.',
      pl: 'Wiatr, zwroty i kat do wiatru. Zacznij tutaj. Wymaga internetu.',
      es: 'Viento, viradas y el angulo al viento. Empieza aqui. Requiere internet.',
      fr: 'Vent, virements et angle au vent. Commence ici. Internet requis.',
      de: 'Wind, Wenden und der Winkel zum Wind. Starte hier. Internet noetig.',
      it: 'Vento, virate e angolo al vento. Inizia qui. Serve internet.',
    },
  },
  {
    route: '/simulator-v3',
