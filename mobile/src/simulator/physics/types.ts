...
//
// Ported verbatim from web src/lib/sailing-physics/types.ts. Engine is the
// golden source; do not "improve" it without bumping the verification suite
// on the web side first.
// ============================================================================
