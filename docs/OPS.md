...
Public surfaces:
- `https://regatta.icoffio.com/sitemap.xml` - 16 routes x 7 hreflang
  alternates, generated by `src/app/sitemap.ts`
- `https://regatta.icoffio.com/robots.txt` - allows public content,
...
5. After verification: submit `https://regatta.icoffio.com/sitemap.xml`
