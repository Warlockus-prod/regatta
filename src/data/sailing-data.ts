...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  { id: 'course-in-irons', termRu: 'Левентик', termEn: 'In Irons / Head to Wind', termPl: 'Pod wiatr (lewentyk)', definition: 'Нос прямо против ветра, яхта не движется', definitionEn: 'Bow pointed directly into wind, boat stalled', definitionPl: 'Dziob skierowany prosto pod wiatr, jacht nie plynie', category: 'course' },
