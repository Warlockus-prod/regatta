...
export const LESSON_TEXT: Record<string, LessonText> = {
  ...
  volume: {
    ...
    whenPl: 'Ustawiasz zaraz po wlaczeniu i poprawiasz za kazdym razem, gdy zmieniaja sie warunki: po uruchomieniu silnika, na kursie pod fale, w halasliwej marinie. Jesli nie slyszysz radia przy sterze, praktycznie go nie masz.',
    whenRu: 'Ставишь сразу после включения и поправляешь каждый раз, когда меняются условия: завели двигатель, пошли против волны, зашли в шумную марину. Если у руля рации не слышно, ее фактически нет.',
