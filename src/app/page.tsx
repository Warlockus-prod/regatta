...
const secondaryTools: Tool[] = [
  ...
  },
  {
    ...
    desc: {
      ru: 'Два уровня: Основы (ветер и повороты) и Тренажёр с живой физикой. Плюс лодка в 3D.',
      en: 'Two tiers: Basics (wind and turns) and a Trainer with live physics. Plus the boat in 3D.',
      pl: 'Dwa poziomy: Podstawy (wiatr i zwroty) i Trener z zywa fizyka. Plus lodka w 3D.',
      es: 'Dos niveles: Basico (viento y giros) y Entrenador con fisica real. Y el barco en 3D.',
      fr: 'Deux niveaux : Bases (vent et virements) et Entraineur a physique reelle. Et le bateau en 3D.',
      de: 'Zwei Stufen: Grundlagen (Wind und Wenden) und Trainer mit echter Physik. Plus Boot in 3D.',
      it: 'Due livelli: Base (vento e virate) e Trainer con fisica reale. E la barca in 3D.',
    },
    accent: 'var(--accent-cyan)',
    icon: '🎮',
  },
