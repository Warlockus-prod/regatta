...
const secondaryTools: Tool[] = [
  ...
  },
  {
    ...
    desc: {
      ru: 'Что взять, что узнать, что сделать перед выходом. Прогресс сохраняется.',
      en: 'What to pack, learn, and do before casting off. Progress saved.',
      pl: 'Co zabrac, czego sie dowiedziec, co zrobic przed wyjsciem. Postep zapisywany.',
      es: 'Que llevar, que saber, que hacer antes de soltar amarras. Progreso guardado.',
      fr: 'Quoi prendre, savoir, faire avant de larguer. Progression sauvegardee.',
      de: 'Was mitnehmen, lernen, tun vor dem Ablegen. Fortschritt gespeichert.',
      it: 'Cosa portare, sapere, fare prima di mollare. Progresso salvato.',
    },
    accent: 'var(--warning)',
    icon: '✅',
  },
